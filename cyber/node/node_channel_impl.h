...
class NodeChannelImpl {
 ...
 public:
  ...
  explicit NodeChannelImpl(const std::string& node_name)
    ...
    std::cout << "HostIp : " << common::GlobalData::Instance()->HostIp() << std::endl;
    std::cout << "ProcessId : " << common::GlobalData::Instance()->ProcessId() << std::endl;
    ...
    if (is_reality_mode_) {
      std::cout << "NodeChannelImpl is_reality_mode : " << is_reality_mode_ << std::endl;
      node_manager_ =
...
auto NodeChannelImpl::CreateWriter(const proto::RoleAttributes& role_attr)
    -> std::shared_ptr<Writer<MessageT>> {
  std::cout << "NodeChannelImpl CreateWriter -- use RoleAttributes -- : " << role_attr.channel_name() << std::endl;
...
auto NodeChannelImpl::CreateWriter(const std::string& channel_name)
  ...
  std::cout << "NodeChannelImpl CreateWriter -- use string -- : " << channel_name << std::endl;
