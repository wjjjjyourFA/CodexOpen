...
void HybridTransmitter<M>::InitMode() {
  ...
  std::cout << "hybrid init mode" << std::endl;
}
...
void HybridTransmitter<M>::InitHistory() {
  std::cout << "hybrid InitHistory()" << std::endl;
  ...
  if (this->attr_.qos_profile().durability() ==
    ...
    history_->Enable();
    std::cout << "hybrid history enable" << std::endl;
  }
}
  ...
  for (auto& mode : modes) {
    switch (mode) {
      case OptionalMode::INTRA:
        std::cout << "HybridTransmitter --> intra" << std::endl;
        transmitters_[mode] =
            std::make_shared<IntraTransmitter<M>>(this->attr_);
        break;
      case OptionalMode::SHM:
        std::cout << "HybridTransmitter --> shm" << std::endl;
        transmitters_[mode] = std::make_shared<ShmTransmitter<M>>(this->attr_);
        break;
      default:
        std::cout << "HybridTransmitter --> rtps" << std::endl;
        transmitters_[mode] =
...
void HybridTransmitter<M>::ThreadFunc(
  ...
  std::cout << " is here to Enalbe Transmitter ? " << std::endl;
