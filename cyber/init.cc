...
bool Init(const char* binary_name, const std::string& dag_info) {
  ...
  std::cout << "Cyber apollo_runtime_path: " << apollo_runtime_path << std::endl;
  ...
  std::cout << "cyber init start : " << binary_name << std::endl;
  ...
  if (global_data->IsMockTimeMode()) {
    std::cout << "cyber init global data : IsMockTimeMode " << std::endl;
