...
// 这个头文件属于 protobuf 的内部实现，一般用户代码不应该依赖它。
// 如果你是直接用 protobuf 解析数据，只需要包含普通的.pb.h 和 protobuf API。
// 如果你是在做 protobuf 编译器相关的扩展或定制，需要使用完整 protobuf 源码。
// #include "google/protobuf/compiler/parser.h"
#include <google/protobuf/descriptor.pb.h>  // for FileDescriptorProto add by jojo
