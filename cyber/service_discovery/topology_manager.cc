...
#include "cyber/time/cyber_time.h"
...
bool TopologyManager::Init() {
  ...
  std::cout << ">>>> TopologyManager Init." << std::endl;
  ...
  if (!result) {
    ...
    std::cout << "TopologyManager init manager failed." << std::endl;
    participant_ = nullptr;
    node_manager_ = nullptr;
    channel_manager_ = nullptr;
    service_manager_ = nullptr;
...
bool TopologyManager::CreateParticipant() {
  ...
  if (!participant_->Init()) {
    ...
    std::cout << "TopologyManager create participant failed." << std::endl;
    return false;
  }
  std::cout << "TopologyManager create participant success." << std::endl;
  return true;
}
