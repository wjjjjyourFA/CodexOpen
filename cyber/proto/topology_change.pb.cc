...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_cyber_2fproto_2frole_5fattributes_2eproto ::google::protobuf::internal::SCCInfo<2> scc_info_RoleAttributes;
}  // namespace protobuf_cyber_2fproto_2frole_5fattributes_2eproto
namespace apollo {
namespace cyber {
namespace proto {
...
::google::protobuf::internal::SCCInfo<1> scc_info_ChangeMsg =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsChangeMsg}, {
      &protobuf_cyber_2fproto_2frole_5fattributes_2eproto::scc_info_RoleAttributes.base,}};
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::ChangeMsg, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::ChangeMsg, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::ChangeMsg, timestamp_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::ChangeMsg, change_type_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::ChangeMsg, operate_type_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::ChangeMsg, role_type_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::ChangeMsg, role_attr_),
  1,
  3,
  4,
  2,
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::apollo::cyber::proto::_ChangeMsg_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cyber/proto/topology_change.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::protobuf_cyber_2fproto_2frole_5fattributes_2eproto::AddDescriptors();
}
...
ChangeMsg::ChangeMsg()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_cyber_2fproto_2ftopology_5fchange_2eproto::scc_info_ChangeMsg.base);
  SharedCtor();
...
const ChangeMsg& ChangeMsg::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cyber_2fproto_2ftopology_5fchange_2eproto::scc_info_ChangeMsg.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::apollo::cyber::proto::ChangeMsg* Arena::CreateMaybeMessage< ::apollo::cyber::proto::ChangeMsg >(Arena* arena) {
