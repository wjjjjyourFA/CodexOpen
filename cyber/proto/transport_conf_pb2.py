...
_ARENACHANNELCONF = _descriptor.Descriptor(
  name='ArenaChannelConf',
  full_name='apollo.cyber.proto.ArenaChannelConf',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='channel_name', full_name='apollo.cyber.proto.ArenaChannelConf.channel_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_msg_size', full_name='apollo.cyber.proto.ArenaChannelConf.max_msg_size', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_pool_size', full_name='apollo.cyber.proto.ArenaChannelConf.max_pool_size', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='shared_buffer_size', full_name='apollo.cyber.proto.ArenaChannelConf.shared_buffer_size', index=3,
...
_ARENASHMCONF = _descriptor.Descriptor(
  name='ArenaShmConf',
  full_name='apollo.cyber.proto.ArenaShmConf',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='arena_channel_conf', full_name='apollo.cyber.proto.ArenaShmConf.arena_channel_conf', index=0,
...
_SHMCONF = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='arena_shm_conf', full_name='apollo.cyber.proto.ShmConf.arena_shm_conf', index=3,
...
_ARENASHMCONF.fields_by_name['arena_channel_conf'].message_type = _ARENACHANNELCONF
_SHMCONF.fields_by_name['shm_locator'].message_type = _SHMMULTICASTLOCATOR
_SHMCONF.fields_by_name['arena_shm_conf'].message_type = _ARENASHMCONF
...
DESCRIPTOR.message_types_by_name['ArenaChannelConf'] = _ARENACHANNELCONF
DESCRIPTOR.message_types_by_name['ArenaShmConf'] = _ARENASHMCONF
...
ArenaChannelConf = _reflection.GeneratedProtocolMessageType('ArenaChannelConf', (_message.Message,), dict(
  DESCRIPTOR = _ARENACHANNELCONF,
  __module__ = 'cyber.proto.transport_conf_pb2'
  # @@protoc_insertion_point(class_scope:apollo.cyber.proto.ArenaChannelConf)
  ))
_sym_db.RegisterMessage(ArenaChannelConf)

ArenaShmConf = _reflection.GeneratedProtocolMessageType('ArenaShmConf', (_message.Message,), dict(
  DESCRIPTOR = _ARENASHMCONF,
  __module__ = 'cyber.proto.transport_conf_pb2'
  # @@protoc_insertion_point(class_scope:apollo.cyber.proto.ArenaShmConf)
  ))
_sym_db.RegisterMessage(ArenaShmConf)
