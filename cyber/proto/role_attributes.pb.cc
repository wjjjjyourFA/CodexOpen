...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_cyber_2fproto_2frole_5fattributes_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_SocketAddr;
}  // namespace protobuf_cyber_2fproto_2frole_5fattributes_2eproto
namespace apollo {
namespace cyber {
namespace proto {
...
::google::protobuf::internal::SCCInfo<2> scc_info_RoleAttributes =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsRoleAttributes}, {
      ...
      &protobuf_cyber_2fproto_2frole_5fattributes_2eproto::scc_info_SocketAddr.base,}};
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cyber/proto/role_attributes.proto", schemas, file_default_instances, TableStruct::offsets,
...
const SocketAddr& SocketAddr::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cyber_2fproto_2frole_5fattributes_2eproto::scc_info_SocketAddr.base);
...
const RoleAttributes& RoleAttributes::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cyber_2fproto_2frole_5fattributes_2eproto::scc_info_RoleAttributes.base);
  return *internal_default_instance();
}
