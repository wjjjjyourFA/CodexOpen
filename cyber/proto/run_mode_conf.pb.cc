...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cyber/proto/run_mode_conf.proto", schemas, file_default_instances, TableStruct::offsets,
...
const ::google::protobuf::EnumDescriptor* ClockMode_descriptor() {
  protobuf_cyber_2fproto_2frun_5fmode_5fconf_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_cyber_2fproto_2frun_5fmode_5fconf_2eproto::file_level_enum_descriptors[1];
}
...
const RunModeConf& RunModeConf::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cyber_2fproto_2frun_5fmode_5fconf_2eproto::scc_info_RunModeConf.base);
