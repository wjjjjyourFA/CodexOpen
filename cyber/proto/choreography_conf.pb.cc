...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_cyber_2fproto_2fchoreography_5fconf_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_ChoreographyTask;
}  // namespace protobuf_cyber_2fproto_2fchoreography_5fconf_2eproto
namespace apollo {
namespace cyber {
namespace proto {
...
::google::protobuf::internal::SCCInfo<1> scc_info_ChoreographyConf =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsChoreographyConf}, {
      &protobuf_cyber_2fproto_2fchoreography_5fconf_2eproto::scc_info_ChoreographyTask.base,}};
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cyber/proto/choreography_conf.proto", schemas, file_default_instances, TableStruct::offsets,
...
const ChoreographyTask& ChoreographyTask::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cyber_2fproto_2fchoreography_5fconf_2eproto::scc_info_ChoreographyTask.base);
...
const ChoreographyConf& ChoreographyConf::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cyber_2fproto_2fchoreography_5fconf_2eproto::scc_info_ChoreographyConf.base);
  return *internal_default_instance();
}
