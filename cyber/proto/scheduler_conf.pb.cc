...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_cyber_2fproto_2fchoreography_5fconf_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_ChoreographyConf;
}  // namespace protobuf_cyber_2fproto_2fchoreography_5fconf_2eproto
namespace protobuf_cyber_2fproto_2fclassic_5fconf_2eproto {
extern PROTOBUF_INTERNAL_EXPORT_protobuf_cyber_2fproto_2fclassic_5fconf_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_ClassicConf;
}  // namespace protobuf_cyber_2fproto_2fclassic_5fconf_2eproto
namespace protobuf_cyber_2fproto_2fscheduler_5fconf_2eproto {
extern PROTOBUF_INTERNAL_EXPORT_protobuf_cyber_2fproto_2fscheduler_5fconf_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_InnerThread;
}  // namespace protobuf_cyber_2fproto_2fscheduler_5fconf_2eproto
namespace apollo {
namespace cyber {
namespace proto {
class InnerThreadDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<InnerThread>
      _instance;
} _InnerThread_default_instance_;
class SchedulerConfDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<SchedulerConf>
      _instance;
...
namespace protobuf_cyber_2fproto_2fscheduler_5fconf_2eproto {
static void InitDefaultsInnerThread() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_InnerThread =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsInnerThread}, {}};

static void InitDefaultsSchedulerConf() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<3> scc_info_SchedulerConf =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 3, InitDefaultsSchedulerConf}, {
      &protobuf_cyber_2fproto_2fscheduler_5fconf_2eproto::scc_info_InnerThread.base,
      &protobuf_cyber_2fproto_2fclassic_5fconf_2eproto::scc_info_ClassicConf.base,
      &protobuf_cyber_2fproto_2fchoreography_5fconf_2eproto::scc_info_ChoreographyConf.base,}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_InnerThread.base);
  ::google::protobuf::internal::InitSCC(&scc_info_SchedulerConf.base);
}

::google::protobuf::Metadata file_level_metadata[2];

const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::InnerThread, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::InnerThread, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::InnerThread, name_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::InnerThread, cpuset_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::InnerThread, policy_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::InnerThread, prio_),
  0,
  1,
  2,
  3,
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::SchedulerConf, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::SchedulerConf, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::SchedulerConf, policy_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::SchedulerConf, routine_num_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::SchedulerConf, default_proc_num_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::SchedulerConf, process_level_cpuset_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::SchedulerConf, threads_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::SchedulerConf, classic_conf_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::cyber::proto::SchedulerConf, choreography_conf_),
  0,
  4,
  5,
  1,
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::apollo::cyber::proto::_InnerThread_default_instance_),
  reinterpret_cast<const ::google::protobuf::Message*>(&::apollo::cyber::proto::_SchedulerConf_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cyber/proto/scheduler_conf.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::protobuf_cyber_2fproto_2fclassic_5fconf_2eproto::AddDescriptors();
  ::protobuf_cyber_2fproto_2fchoreography_5fconf_2eproto::AddDescriptors();
}
...
const InnerThread& InnerThread::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cyber_2fproto_2fscheduler_5fconf_2eproto::scc_info_InnerThread.base);
...
void SchedulerConf::clear_classic_conf() {
  if (classic_conf_ != NULL) classic_conf_->Clear();
  clear_has_classic_conf();
}
void SchedulerConf::clear_choreography_conf() {
  if (choreography_conf_ != NULL) choreography_conf_->Clear();
...
SchedulerConf::SchedulerConf()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_cyber_2fproto_2fscheduler_5fconf_2eproto::scc_info_SchedulerConf.base);
  SharedCtor();
...
const SchedulerConf& SchedulerConf::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cyber_2fproto_2fscheduler_5fconf_2eproto::scc_info_SchedulerConf.base);
  return *internal_default_instance();
}
...
void SchedulerConf::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x00000004u) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      6, this->_internal_classic_conf(), output);
  }

  // optional .apollo.cyber.proto.ChoreographyConf choreography_conf = 7;
  if (cached_has_bits & 0x00000008u) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      7, this->_internal_choreography_conf(), output);
  }
...
::google::protobuf::uint8* SchedulerConf::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        5, this->threads(static_cast<int>(i)), deterministic, target);
  }
  ...
  if (cached_has_bits & 0x00000004u) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        6, this->_internal_classic_conf(), deterministic, target);
  }
  ...
  if (cached_has_bits & 0x00000008u) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        7, this->_internal_choreography_conf(), deterministic, target);
  }
...
void SchedulerConf::InternalSwap(SchedulerConf* other) {
  ...
  policy_.Swap(&other->policy_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  process_level_cpuset_.Swap(&other->process_level_cpuset_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::apollo::cyber::proto::InnerThread* Arena::CreateMaybeMessage< ::apollo::cyber::proto::InnerThread >(Arena* arena) {
  return Arena::CreateInternal< ::apollo::cyber::proto::InnerThread >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::apollo::cyber::proto::SchedulerConf* Arena::CreateMaybeMessage< ::apollo::cyber::proto::SchedulerConf >(Arena* arena) {
