...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cyber/proto/qos_profile.proto", schemas, file_default_instances, TableStruct::offsets,
...
const QosProfile& QosProfile::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cyber_2fproto_2fqos_5fprofile_2eproto::scc_info_QosProfile.base);
