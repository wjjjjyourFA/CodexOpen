...
namespace LI2Sup{
  ...
  extern int   g_lidar_type;       // 1: mid360, 2: hesai16, 3: velo16, 4: velo32, 5: vel_nclt, 6: ls16, 7: ouster, 8: rs128, 9: normal PointCloud2/PCD
  extern float g_blind2;
  extern float g_maxrange2;
  extern float g_box_x_min;
  extern float g_box_x_max;
  extern float g_box_y_min;
  extern float g_box_y_max;
  extern float g_box_z_min;
  extern float g_box_z_max;
  extern int   g_filter_rate;
  extern bool  g_enable_downsample;
  extern float g_voxel_fliter_size;

  extern bool g_qlu_or_rqu;
  extern bool g_b_rawimu;
  ...
  /// occupancy-map compatibility parameters retained from relocation mode
  extern float g_occ_resolution;
  extern float g_occ_size_x;
  extern float g_occ_size_y;
  extern float g_occ_size_z;
  extern float g_occ_update_range;
  extern bool  g_enable_virtual_wall;
  extern bool  g_slide_update;
  ...
  extern bool g_ax7_compat_output;
