...
SELF_PATH = $$CODEX_PATH/modules/mapping/mapper
...
DESTDIR = $$CODEX_PATH/install/bin/modules/mapping/mapper
...
SOURCES += \
  ...
  $$CODEX_PATH/modules/mapping/map_processing/downsampling.cpp \
  $$CODEX_PATH/modules/mapping/map_processing/utils.cpp \
  $$SELF_PATH/mapper.cpp \
  $$SELF_PATH/mapper_color.cpp \
  $$SELF_PATH/run_mapper_color.cpp
...
HEADERS += \
  ...
  $$CODEX_PATH/modules/mapping/map_processing/downsampling.h \
  $$CODEX_PATH/modules/mapping/map_processing/utils.h \
  $$SELF_PATH/mapper.h \
  $$SELF_PATH/mapper_color.h \
