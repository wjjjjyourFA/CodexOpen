...
TARGET = label_map_generate

CODEX_PATH = $$PWD/../../../../../CodexOpen
PREFIX = $$CODEX_PATH/modules/perception/common
SELF_PATH = $$CODEX_PATH/modules/mapping/map_visualization
...
DESTDIR = $$CODEX_PATH/install/bin/modules/mapping/map_visualization
...
SOURCES += \
  ...
  $$CODEX_PATH/modules/mapping/map_representation/*.cpp \
  $$SELF_PATH/post_process.cpp \
  $$SELF_PATH/map_visualization.cpp \
  $$SELF_PATH/run_label_map_generate.cpp
...
HEADERS += \
  ...
  $$CODEX_PATH/modules/mapping/map_representation/*.h \
  $$SELF_PATH/post_process.h \
  $$SELF_PATH/map_visualization.h \
