...
contains(IMAGE_DEEPSORT, 1){
SOURCES += \
  $$SELF_PATH/tracking/deepsort/deepsort_wrapper.cpp \
  $$SELF_PATH/tracking/deepsort/src/*.cpp \

HEADERS += \
  $$SELF_PATH/tracking/deepsort/deepsort_wrapper.h \
  $$SELF_PATH/tracking/deepsort/include/*.h \
  $$SELF_PATH/tracking/deepsort/include/*.hpp \

INCLUDEPATH += \
  /opt/TensorRT/include \
  $$SELF_PATH/tracking/deepsort \
  $$SELF_PATH/tracking/deepsort/include \
}
