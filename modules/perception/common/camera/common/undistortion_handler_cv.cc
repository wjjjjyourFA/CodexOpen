...
void UndistortionHandlerCv::InitUndistortRectifyMap(
...
void UndistortionHandlerCv::InitFisheyeUndistortRectifyMap(
    const Eigen::Matrix3f& intrinsic_params,
    const Eigen::Matrix<float, 8, 1>& distort_params, int width, int height) {
  // std::cout << "[UndistortionHandlerCv] InitFisheyeUndistortRectifyMap() called" << std::endl;
