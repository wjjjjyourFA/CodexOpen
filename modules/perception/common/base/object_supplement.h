...
struct CameraObjectSupplement {
  ...
  void Reset() {
    ...
    // box = BBox2D<float>();
    box.Reset();
    // box3d_supplement = BBox3D<float>();
    // box3d_supplement = jojo::perception::base::BBox3DExtra();
    box3d_supplement.Reset();
  ...
  // 借助 lidar or radar 补全的 3D 信息
  // @brief 3d box
  // BBox3D<float> box3d_supplement;
  jojo::perception::base::BBox3DExtra box3d_supplement;
