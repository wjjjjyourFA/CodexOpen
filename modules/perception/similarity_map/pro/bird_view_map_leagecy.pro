...
DESTDIR = $$CODEX_PATH/install/bin/modules/perception/similarity_map
...
SOURCES += \
  ...
  $$CODEX_PATH/modules/perception/lidar_local_mapping/lidar_local_mapping.cpp \
  $$SELF_PATH/config/runtime_config.cpp \
  $$SELF_PATH/bird_view_map_leagecy.cpp \
  $$SELF_PATH/run_bird_view_map.cpp
...
HEADERS += \
  ...
  $$CODEX_PATH/modules/perception/lidar_local_mapping/common.h \
  $$CODEX_PATH/modules/perception/lidar_local_mapping/local_mapping_base.h \
  $$CODEX_PATH/modules/perception/lidar_local_mapping/lidar_local_mapping.h \
  $$SELF_PATH/config/runtime_config.h \
  $$SELF_PATH/bird_view_map_leagecy.h \
...
LIBS += \
  ...
  -lpcl_visualization -lpcl_kdtree \
  -lpthread -lglog -lyaml-cpp -lprotobuf -llz4 \
  -lflann_cpp_s -lflann -lpcl_filters
