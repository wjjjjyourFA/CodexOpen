...
#ifndef PROTOBUF_INCLUDED_modules_2fcommon_5fmsgs_2fsensor_5fmsgs_2fgnss_5fbest_5fpose_2eproto
#define PROTOBUF_INCLUDED_modules_2fcommon_5fmsgs_2fsensor_5fmsgs_2fgnss_5fbest_5fpose_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_modules_2fcommon_5fmsgs_2fsensor_5fmsgs_2fgnss_5fbest_5fpose_2eproto 
...
class GnssBestPose : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.drivers.gnss.GnssBestPose) */ {
 public:
  ...
  inline GnssBestPose* New() const final {
    return CreateMaybeMessage<GnssBestPose>(NULL);
  }

  GnssBestPose* New(::google::protobuf::Arena* arena) const final {
 ...
 private:
  ...
  void set_has_sol_type();
  void clear_has_sol_type();
  void set_has_latitude();
  void clear_has_latitude();
  void set_has_longitude();
  void clear_has_longitude();
  void set_has_height_msl();
  void clear_has_height_msl();
  void set_has_undulation();
  void clear_has_undulation();
  void set_has_datum_id();
  void clear_has_datum_id();
  void set_has_latitude_std_dev();
  void clear_has_latitude_std_dev();
  void set_has_longitude_std_dev();
  void clear_has_longitude_std_dev();
  void set_has_height_std_dev();
  void clear_has_height_std_dev();
  void set_has_base_station_id();
  void clear_has_base_station_id();
  void set_has_differential_age();
  void clear_has_differential_age();
  void set_has_solution_age();
  void clear_has_solution_age();
  void set_has_num_sats_tracked();
  void clear_has_num_sats_tracked();
  void set_has_num_sats_in_solution();
  void clear_has_num_sats_in_solution();
  void set_has_num_sats_l1();
  void clear_has_num_sats_l1();
  void set_has_num_sats_multi();
  void clear_has_num_sats_multi();
  void set_has_reserved();
  void clear_has_reserved();
  void set_has_extended_solution_status();
  void clear_has_extended_solution_status();
  void set_has_galileo_beidou_used_mask();
  void clear_has_galileo_beidou_used_mask();
  void set_has_gps_glonass_used_mask();
  void clear_has_gps_glonass_used_mask();
  ...
  int datum_id_;
  friend struct ::protobuf_modules_2fcommon_5fmsgs_2fsensor_5fmsgs_2fgnss_5fbest_5fpose_2eproto::TableStruct;
};
// ===================================================================
...
inline ::std::string* GnssBestPose::release_base_station_id() {
  ...
  clear_has_base_station_id();
  return base_station_id_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
#endif  // PROTOBUF_INCLUDED_modules_2fcommon_5fmsgs_2fsensor_5fmsgs_2fgnss_5fbest_5fpose_2eproto
