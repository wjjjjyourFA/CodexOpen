...
_MONITORMESSAGEITEM_MESSAGESOURCE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NANO_RADAR', index=21, number=22,
      serialized_options=None,
      type=None),
  ],
