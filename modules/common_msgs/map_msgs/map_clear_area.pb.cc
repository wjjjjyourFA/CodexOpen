...
static void InitDefaultsClearArea() {
...
::google::protobuf::internal::SCCInfo<2> scc_info_ClearArea =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsClearArea}, {
...
void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_ClearArea.base);
}

::google::protobuf::Metadata file_level_metadata[1];

const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::hdmap::ClearArea, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::hdmap::ClearArea, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::hdmap::ClearArea, id_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::hdmap::ClearArea, overlap_id_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::hdmap::ClearArea, polygon_),
  0,
  ~0u,
  1,
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::apollo::hdmap::_ClearArea_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/common_msgs/map_msgs/map_clear_area.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n1modules/common_msgs/map_msgs/map_clear"
      "_area.proto\022\014apollo.hdmap\032/modules/commo"
      ...
      "\n\007polygon\030\003 \001(\0132\025.apollo.hdmap.Polygon"
  };
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
      descriptor, 278);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "modules/common_msgs/map_msgs/map_clear_area.proto", &protobuf_RegisterTypes);
...
const ::google::protobuf::Descriptor* ClearArea::descriptor() {
  ::protobuf_modules_2fcommon_5fmsgs_2fmap_5fmsgs_2fmap_5fclear_5farea_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_modules_2fcommon_5fmsgs_2fmap_5fmsgs_2fmap_5fclear_5farea_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const ClearArea& ClearArea::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fcommon_5fmsgs_2fmap_5fmsgs_2fmap_5fclear_5farea_2eproto::scc_info_ClearArea.base);
...
::google::protobuf::Metadata ClearArea::GetMetadata() const {
  protobuf_modules_2fcommon_5fmsgs_2fmap_5fmsgs_2fmap_5fclear_5farea_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_modules_2fcommon_5fmsgs_2fmap_5fmsgs_2fmap_5fclear_5farea_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::apollo::hdmap::ClearArea* Arena::CreateMaybeMessage< ::apollo::hdmap::ClearArea >(Arena* arena) {
