...
_LAYOUT = _descriptor.Descriptor(
  name='Layout',
  full_name='apollo.dreamview.Layout',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='apollo.dreamview.Layout.type', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='first', full_name='apollo.dreamview.Layout.first', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='second', full_name='apollo.dreamview.Layout.second', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='direction', full_name='apollo.dreamview.Layout.direction', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='splitPercentage', full_name='apollo.dreamview.Layout.splitPercentage', index=4,
      number=5, type=1, cpp_type=5, label=1,
...
_LAYOUT.fields_by_name['first'].message_type = _LAYOUT
_LAYOUT.fields_by_name['second'].message_type = _LAYOUT
...
_HMIMODE.fields_by_name['layout'].message_type = _LAYOUT
...
HMIMode = _reflection.GeneratedProtocolMessageType('HMIMode', (_message.Message,), dict(
  ...
  GlobalComponentsEntry = _reflection.GeneratedProtocolMessageType('GlobalComponentsEntry', (_message.Message,), dict(
