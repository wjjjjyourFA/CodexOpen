...
#ifndef PROTOBUF_INCLUDED_modules_2fcommon_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fid_2eproto
#define PROTOBUF_INCLUDED_modules_2fcommon_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fid_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_modules_2fcommon_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fid_2eproto 
...
class VehicleID : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.common.VehicleID) */ {
 public:
  ...
  inline VehicleID* New() const final {
    return CreateMaybeMessage<VehicleID>(NULL);
  }

  VehicleID* New(::google::protobuf::Arena* arena) const final {
...
inline ::std::string* VehicleID::release_plate() {
  ...
  clear_has_plate();
  return plate_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* VehicleID::release_other_unique_id() {
  ...
  clear_has_other_unique_id();
  return other_unique_id_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
#endif  // PROTOBUF_INCLUDED_modules_2fcommon_5fmsgs_2fbasic_5fmsgs_2fvehicle_5fid_2eproto
