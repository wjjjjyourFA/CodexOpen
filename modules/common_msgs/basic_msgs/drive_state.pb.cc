...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/common_msgs/basic_msgs/drive_state.proto", schemas, file_default_instances, TableStruct::offsets,
...
const EngageAdvice& EngageAdvice::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fcommon_5fmsgs_2fbasic_5fmsgs_2fdrive_5fstate_2eproto::scc_info_EngageAdvice.base);
