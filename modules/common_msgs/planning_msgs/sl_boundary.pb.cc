...
static void InitDefaultsSLBoundary() {
  ...
  ::apollo::planning::SLBoundary::InitAsDefaultInstance();
}

::google::protobuf::internal::SCCInfo<1> scc_info_SLBoundary =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsSLBoundary}, {
      &protobuf_modules_2fcommon_5fmsgs_2fbasic_5fmsgs_2fpnc_5fpoint_2eproto::scc_info_SLPoint.base,}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_SLBoundary.base);
}

::google::protobuf::Metadata file_level_metadata[1];

const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::planning::SLBoundary, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::planning::SLBoundary, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::planning::SLBoundary, start_s_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::planning::SLBoundary, end_s_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::planning::SLBoundary, start_l_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::planning::SLBoundary, end_l_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::apollo::planning::SLBoundary, boundary_point_),
  0,
  1,
  2,
  3,
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::apollo::planning::_SLBoundary_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "modules/common_msgs/planning_msgs/sl_boundary.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n3modules/common_msgs/planning_msgs/sl_b"
      "oundary.proto\022\017apollo.planning\032.modules/"
      ...
      "boundary_point\030\005 \003(\0132\026.apollo.common.SLP"
      "oint"
  };
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
      descriptor, 244);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "modules/common_msgs/planning_msgs/sl_boundary.proto", &protobuf_RegisterTypes);
...
const ::google::protobuf::Descriptor* SLBoundary::descriptor() {
  ::protobuf_modules_2fcommon_5fmsgs_2fplanning_5fmsgs_2fsl_5fboundary_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_modules_2fcommon_5fmsgs_2fplanning_5fmsgs_2fsl_5fboundary_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const SLBoundary& SLBoundary::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_modules_2fcommon_5fmsgs_2fplanning_5fmsgs_2fsl_5fboundary_2eproto::scc_info_SLBoundary.base);
  ...
  for (unsigned int i = 0,
    ...
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        5, this->boundary_point(static_cast<int>(i)), deterministic, target);
  }
...
::google::protobuf::Metadata SLBoundary::GetMetadata() const {
  protobuf_modules_2fcommon_5fmsgs_2fplanning_5fmsgs_2fsl_5fboundary_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_modules_2fcommon_5fmsgs_2fplanning_5fmsgs_2fsl_5fboundary_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::apollo::planning::SLBoundary* Arena::CreateMaybeMessage< ::apollo::planning::SLBoundary >(Arena* arena) {
  return Arena::CreateInternal< ::apollo::planning::SLBoundary >(arena);
}
}  // namespace protobuf
}  // namespace google
