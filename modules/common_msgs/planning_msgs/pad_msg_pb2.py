...
_PADMESSAGE_DRIVINGACTION = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ENTER_MISSION', index=8, number=7,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EXIT_MISSION', index=9, number=8,
      serialized_options=None,
      type=None),
  ],
