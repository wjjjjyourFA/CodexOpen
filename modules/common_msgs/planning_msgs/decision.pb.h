...
#ifndef PROTOBUF_INCLUDED_modules_2fcommon_5fmsgs_2fplanning_5fmsgs_2fdecision_2eproto
#define PROTOBUF_INCLUDED_modules_2fcommon_5fmsgs_2fplanning_5fmsgs_2fdecision_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_modules_2fcommon_5fmsgs_2fplanning_5fmsgs_2fdecision_2eproto 
...
class TargetLane : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.planning.TargetLane) */ {
 ...
 private:
  ...
  double end_s_;
  double speed_limit_;
  friend struct ::protobuf_modules_2fcommon_5fmsgs_2fplanning_5fmsgs_2fdecision_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class ObjectStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.planning.ObjectStatus) */ {
 public:
  ObjectStatus();
  ...
  inline ObjectStatus* New() const final {
    return CreateMaybeMessage<ObjectStatus>(NULL);
  }
...
class ObjectStatic : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.planning.ObjectStatic) */ {
 public:
  ObjectStatic();
  ...
  inline ObjectStatic* New() const final {
    return CreateMaybeMessage<ObjectStatic>(NULL);
  }
...
class ObjectDynamic : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.planning.ObjectDynamic) */ {
 public:
  ObjectDynamic();
  ...
  inline ObjectDynamic* New() const final {
    return CreateMaybeMessage<ObjectDynamic>(NULL);
  }
...
class ObjectMotionType : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.planning.ObjectMotionType) */ {
 public:
  ObjectMotionType();
  ...
  inline ObjectMotionType* New() const final {
    return CreateMaybeMessage<ObjectMotionType>(NULL);
  }
...
inline void ObjectStatus::clear_motion_type() {
  if (motion_type_ != NULL) motion_type_->Clear();
...
inline ::apollo::planning::ObjectMotionType* ObjectStatus::mutable_motion_type() {
  ...
  if (motion_type_ == NULL) {
    auto* p = CreateMaybeMessage<::apollo::planning::ObjectMotionType>(GetArenaNoVirtual());
    motion_type_ = p;
  }
...
inline void ObjectStatus::clear_decision_type() {
  if (decision_type_ != NULL) decision_type_->Clear();
...
inline ::apollo::planning::ObjectStatic* ObjectMotionType::mutable_static_() {
  if (!has_static_()) {
    clear_motion_tag();
    set_has_static_();
    motion_tag_.static__ = CreateMaybeMessage< ::apollo::planning::ObjectStatic >(
        GetArenaNoVirtual());
  }
...
inline ::apollo::planning::ObjectDynamic* ObjectMotionType::mutable_dynamic() {
  if (!has_dynamic()) {
    clear_motion_tag();
    set_has_dynamic();
    motion_tag_.dynamic_ = CreateMaybeMessage< ::apollo::planning::ObjectDynamic >(
        GetArenaNoVirtual());
  }
...
inline ::apollo::planning::ObjectSidePass* ObjectDecisionType::mutable_side_pass() {
  if (!has_side_pass()) {
    clear_object_tag();
    set_has_side_pass();
    object_tag_.side_pass_ = CreateMaybeMessage< ::apollo::planning::ObjectSidePass >(
        GetArenaNoVirtual());
  }
...
inline void DecisionResult::set_allocated_vehicle_signal(::apollo::common::VehicleSignal* vehicle_signal) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(vehicle_signal_);
  }
  if (vehicle_signal) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
...
#endif  // PROTOBUF_INCLUDED_modules_2fcommon_5fmsgs_2fplanning_5fmsgs_2fdecision_2eproto
