...
#elif defined(DATA_PROCESSOR_ROS1_RS)
#include "tools/data_processor/ros1_convert_rs.h"
#elif defined(DATA_PROCESSOR_ROS1_RS_LEGACY)
...
#if defined(DATA_PROCESSOR_ROS1_RS) || defined(DATA_PROCESSOR_ROS1_RS_LEGACY)
    auto _pRos1Convert = std::make_shared<Ros1ConvertRs>(nh, private_nh);
#else
