#-------------------------------------------------
#
# Project created by QtCreator 2025-09-05T15:51:03
#
#-------------------------------------------------
TEMPLATE = app
QT += multimedia multimediawidgets widgets
CONFIG += c++17 object_parallel_to_source
DEFINES += CAPTURE_BACKEND_QT5
TARGET = capture_record_qt5
...
SOURCES += \
  ...
  $$SELF_PATH/qt5/mainwindow_qt5.cpp \
  $$SELF_PATH/qt5/camera_device.cpp \

HEADERS += \
  $$SELF_PATH/imagesettings.h \
  $$SELF_PATH/videosettings.h \
  $$SELF_PATH/qt5/mainwindow_qt5.h \
  $$SELF_PATH/qt5/camera_device.h \
