...
class MainWindow : public QMainWindow {
 ...
 private slots:
  ...
  void updateRecordError(const QString& devKey, int errorCode);
 ...
 private:
  ...
  // ErrorCode
  bool recordErrorPopupShown_ = false;  // 是否已经弹过弹窗
  QStringList pendingErrors_;  // 待显示的错误信息
...
#if defined(CAPTURE_RM1000)
  std::unique_ptr<SerialRM1000> serialPtr = nullptr;
#else
  // SerialRS232* serial;
