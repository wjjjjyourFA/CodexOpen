...
#if (defined(CAPTURE_BACKEND_FFMPEG) + defined(CAPTURE_BACKEND_OPENCV) + \
     defined(CAPTURE_BACKEND_QT5) + defined(CAPTURE_BACKEND_V4L2)) != 1
#error "Define exactly one CAPTURE_BACKEND_* macro"
#endif

#if defined(CAPTURE_BACKEND_FFMPEG)
#include "tools/capture_record/ffmpeg/mainwindow_ffmpeg.h"
#elif defined(CAPTURE_BACKEND_OPENCV)
#include "tools/capture_record/opencv/mainwindow_cv.h"
#elif defined(CAPTURE_BACKEND_QT5)
#include "tools/capture_record/qt5/mainwindow_qt5.h"
#elif defined(CAPTURE_BACKEND_V4L2)
