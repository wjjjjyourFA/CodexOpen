#ifndef LOCAL_TARGET_ATTRIBUTE_CONVERT_H
#define LOCAL_TARGET_ATTRIBUTE_CONVERT_H

#include <publish_msg_base/publish_msg_wrapper.h>
#include <subscribe_msg_base/subscribe_msg_wrapper.h>
#include "ros2/msg/local_target_attribute.hpp"
#include "dds/msg/LocalTargetAttribute.hpp"

class ROS2_To_DDS_LocalTargetAttribute : public SubscribeROS2Msg<ros2::msg::LocalTargetAttribute>,
	public PublishDDSMsg<dds::msg::LocalTargetAttribute>
{
public:
	ROS2_To_DDS_LocalTargetAttribute(const std::shared_ptr<rclcpp::Node> &rcl_node,
		std::string sub_topic_name,
		uint32_t domain_id,
		std::string pub_topic_name,
		bool zcc_flag = false)
		: SubscribeROS2Msg<ros2::msg::LocalTargetAttribute>(rcl_node, sub_topic_name, sub_topic_name),
		PublishDDSMsg<dds::msg::LocalTargetAttribute>(domain_id, pub_topic_name, zcc_flag)
	{
		auto func = [this](const ros2::msg::LocalTargetAttribute &ros2_msg)
		{
			dds::msg::LocalTargetAttribute dds_msg;
...
class DDS_To_ROS2_LocalTargetAttribute : public SubscribeDDSMsg<dds::msg::LocalTargetAttribute>, 
	public PublishROS2Msg<ros2::msg::LocalTargetAttribute>
{
public:
	DDS_To_ROS2_LocalTargetAttribute(const std::shared_ptr<rclcpp::Node> &rcl_node,
		std::string sub_topic_name,
		uint32_t domain_id,
		std::string pub_topic_name,
		bool zcc_flag = false)
		: SubscribeDDSMsg<dds::msg::LocalTargetAttribute>(sub_topic_name, sub_topic_name, domain_id, zcc_flag),
		PublishROS2Msg<ros2::msg::LocalTargetAttribute>(rcl_node, pub_topic_name)
	{
		auto func = [this](const dds::msg::LocalTargetAttribute &dds_msg)
		{
			ros2::msg::LocalTargetAttribute ros2_msg;
...
#endif // LOCAL_TARGET_ATTRIBUTE_CONVERT_H