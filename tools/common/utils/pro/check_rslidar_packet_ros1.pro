...
TARGET = check_rslidar_packet_ros1

CODEX_PATH = $$PWD/../../../../../CodexOpen
PREFIX = $$CODEX_PATH/modules/perception
SELF_PATH = $$CODEX_PATH/tools/common/utils
DATA_PROCESSOR_PATH = $$CODEX_PATH/tools/data_processor

DESTDIR = $$CODEX_PATH/install/bin/tools/check
...
SOURCES += \
  ...
  $$SELF_PATH/check_rslidar_packet_ros1.cpp
...
INCLUDEPATH += \
  $$CODEX_PATH \
  $$DATA_PROCESSOR_PATH/ros1_message \
